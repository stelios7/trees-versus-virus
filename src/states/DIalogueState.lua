...
function DialogueState:init(text, callback)
    ...
    self.textpanel:addChild(Textbox({x=6,y=VIRTUAL_HEIGHT-134,width=VIRTUAL_WIDTH-12,height=128,message={text=text,font=gFonts.odibee.medium}},function()self.textpanel.visible=false end))
